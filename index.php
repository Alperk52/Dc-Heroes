...
<head>
	<meta charset="utf-8" />
	<meta name="description" content="Dc Univserse. - Biggest information site!">
...
<body>
	  <header id="header">
	    <a href="index.php"><img height="150" src="images/dc.gif"></a>
	    <h4><a href="index.php">DC Heroes</a></h4>
	  </header>
...
<textarea class="text-area" rows="4" cols="50" name="comment" form="usrform"> Enter text here...</textarea>
</div>
<div class="divSubmit">
...
<?php
 ...
 {
  echo "<h5>please select an hero</h5>";
 }
?>
</div>
